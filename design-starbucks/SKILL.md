---
name: "design-starbucks"
description: "Apply Starbucks design system aesthetic. Starbucks brand design system. Triggers: 'use design-starbucks', 'design starbucks', 'design-starbucks task'."
...
User asks to build, scaffold, or style UI matching Starbucks's visual language. Also: "make it look like Starbucks", "use Starbucks aesthetic", "Starbucks-style components".
...
- `DESIGN.md` — full design system spec (Starbucks)
...
- Building production replica of Starbucks itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Starbucks style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Starbucks"
