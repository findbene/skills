...
description: 'Creates structured sales briefs, deal summaries, contact notes, and follow-up sequences formatted for HubSpot CRM — includin. Triggers: "use hubspot-sales-brief", "hubspot sales brief", "hubspot task.'
...
- Task is unrelated to hubspot sales brief — pick a domain-specific skill instead
...
| "Generic template is good enough" | Hubspot Sales Brief needs domain-specific judgment, not boilerplate |
...
Done when:
- Primary deliverable produced matches user's stated goal for hubspot sales brief
...
- Input: standard user request involving hubspot sales brief
