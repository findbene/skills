...
description: "High-quality frontend UI design for creating distinctive, production-grade interfaces with modern aesthetics, strong visual hierarchy, and polished UX. Use this skill any time frontend designs need to be created with strong visual quality, UI mockups need to be built, or production-grade interfaces need to be designed. Trigger immediately on: \"frontend design\", \"UI design\", \"design this interface\", \"create a UI\", \"visual design\", \"design mockup\", \"UI mockup\", \"design the frontend\", \"make this look good\", \"UI layout\", \"beautiful UI\", \"modern design\", \"design this page\", \"interface design\". If someone says \"design this UI\" or \"make this look professional\" this skill MUST trigger."
version: 2.0.0
triggers:
  - build a website
  - create a component
