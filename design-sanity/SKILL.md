---
name: "design-sanity"
description: "Apply Sanity design system aesthetic. Sanity brand design system. Triggers: 'use design-sanity', 'design sanity', 'design-sanity task'."
...
User asks to build, scaffold, or style UI matching Sanity's visual language. Also: "make it look like Sanity", "use Sanity aesthetic", "Sanity-style components".
...
- `DESIGN.md` — full design system spec (Sanity)
...
- Building production replica of Sanity itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Sanity style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Sanity"
