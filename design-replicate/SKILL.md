...
description: "Apply Replicate design system aesthetic. Replicate brand design system. Triggers: 'use design-replicate', 'design replicate', 'design-replicate task'."
...
- Building production replica of Replicate itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Replicate style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Replicate"
