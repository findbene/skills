---
name: "cpo-advisor"
description: "Product leadership for scaling companies. Product vision, portfolio strategy, product-market fit, and product org design. Triggers: 'use cpo-advisor', 'cpo advisor', 'cpo-advisor task'."
...
CPO, product strategy, product-market fit, product organization, portfolio prioritization, or roadmap strategy

## When NOT to use

- Task is unrelated to cpo advisor — pick a domain-specific skill instead
...
Done when:
- Primary deliverable produced matches user's stated goal for cpo advisor
...
- Input: standard user request involving cpo advisor
