---
name: "design-wise"
description: "Apply Wise design system aesthetic. Wise brand design system. Triggers: 'use design-wise', 'design wise', 'design-wise task'."
...
- Building production replica of Wise itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Wise style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Wise"
