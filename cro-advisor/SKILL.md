---
name: "cro-advisor"
description: "Revenue leadership for B2B SaaS companies. Revenue forecasting, sales model design, pricing strategy, net revenue retention, and sales t. Triggers: 'use cro-advisor', 'cro advisor', 'cro-advisor task."
...
CRO, chief revenue officer, revenue strategy, sales model, ARR growth, NRR, expansion revenue, churn, pricing strategy, or sales capacity

## When NOT to use

- Task is unrelated to cro advisor — pick a domain-specific skill instead
...
Done when:
- Primary deliverable produced matches user's stated goal for cro advisor
...
- Input: standard user request involving cro advisor
