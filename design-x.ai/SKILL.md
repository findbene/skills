---
name: "design-x.ai"
description: "Apply X.Ai design system aesthetic. X. Triggers: 'use design-x.ai', 'design x.ai', 'design-x.ai task'."
...
- Building production replica of X Ai itself (trademark / IP risk)
...
- Input: "Build a marketing hero in X Ai style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like X Ai"
