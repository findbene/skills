---
name: "design-sentry"
description: "Apply Sentry design system aesthetic. Sentry brand design system. Triggers: 'use design-sentry', 'design sentry', 'design-sentry task'."
...
User asks to build, scaffold, or style UI matching Sentry's visual language. Also: "make it look like Sentry", "use Sentry aesthetic", "Sentry-style components".
...
- `DESIGN.md` — full design system spec (Sentry)
...
- Building production replica of Sentry itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Sentry style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Sentry"
