...
description: "Strategic product leadership toolkit for Head of Product covering OKR cascade generation, quarterly planning, compe. Triggers: 'use product-strategist', 'product strategist', 'product-strategist task."
...
- Task is unrelated to product strategist — pick a domain-specific skill instead
...
| "Generic template is good enough" | Product Strategist needs domain-specific judgment, not boilerplate |
...
Done when:
- Primary deliverable produced matches user's stated goal for product strategist
...
- Input: standard user request involving product strategist
