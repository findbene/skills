---
name: "design-spotify"
description: "Apply Spotify design system aesthetic. Spotify brand design system. Triggers: 'use design-spotify', 'design spotify', 'design-spotify task'."
...
User asks to build, scaffold, or style UI matching Spotify's visual language. Also: "make it look like Spotify", "use Spotify aesthetic", "Spotify-style components".
...
- `DESIGN.md` — full design system spec (Spotify)
...
- Building production replica of Spotify itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Spotify style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Spotify"
