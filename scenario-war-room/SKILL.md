...
description: "Cross-functional what-if modeling for cascading multi-variable scenarios. Triggers: 'use scenario-war-room', 'scenario war room', 'scenario-war-room task'."
...
1. [Action] — cost: $X — impact: [what it buys] — owner: [role] — deadline: [date] → verify: step output matches expected outcome
2. [Action] — cost: $X — impact: [what it buys] — owner: [role] — deadline: [date] → verify: step output matches expected outcome
3. [Action] — cost: $X — impact: [what it buys] — owner: [role] — deadline: [date] → verify: step output matches expected outcome
...
- Task is unrelated to scenario war room — pick a domain-specific skill instead
...
| "Generic template is good enough" | Scenario War Room needs domain-specific judgment, not boilerplate |
...
Done when:
- Primary deliverable produced matches user's stated goal for scenario war room
...
- Input: standard user request involving scenario war room
