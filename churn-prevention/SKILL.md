...
Retention platforms (Churnkey, ProsperStack, Raaft), billing/dunning providers (Stripe, Chargebee, Paddle, Recurly), and analytics CLI tools.

See [references/tool-integrations.md](references/tool-integrations.md) for the full tool comparison tables.
