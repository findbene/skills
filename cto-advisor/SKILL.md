---
name: "cto-advisor"
description: "Technical leadership guidance for engineering teams, architecture decisions, and technology strategy. Triggers: 'use cto-advisor', 'cto advisor', 'cto-advisor task'."
...
CTO, tech debt, technical debt, team scaling, architecture decisions, technology evaluation, engineering metrics, DORA metrics, or technology strategy

## When NOT to use

- Task is unrelated to cto advisor — pick a domain-specific skill instead
...
Done when:
- Primary deliverable produced matches user's stated goal for cto advisor
...
- Input: standard user request involving cto advisor
