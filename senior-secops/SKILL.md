---
name: "senior-secops"
description: "Senior SecOps engineer skill for application security, vulnerability management, compliance verification, and secure development p. Triggers: 'use senior-secops', 'senior secops', 'senior-secops task."
...
```
1. ASSESS (0-2 hours) → verify: step output matches expected outcome
...
2. PRIORITIZE → verify: step output matches expected outcome
   - Critical (CVSS 9.0+, internet-facing): 24 hours
   - High (CVSS 7.0-8.9): 7 days
   - Medium (CVSS 4.0-6.9): 30 days
   - Low (CVSS < 4.0): 90 days

3. REMEDIATE → verify: step output matches expected outcome
...
- Task is unrelated to senior secops — pick a domain-specific skill instead
...
| "Generic template is good enough" | Senior Secops needs domain-specific judgment, not boilerplate |
...
Done when:
- Primary deliverable produced matches user's stated goal for senior secops
...
- Input: standard user request involving senior secops
