---
name: "design-renault"
description: "Apply Renault design system aesthetic. Renault brand design system. Triggers: 'use design-renault', 'design renault', 'design-renault task'."
...
User asks to build, scaffold, or style UI matching Renault's visual language. Also: "make it look like Renault", "use Renault aesthetic", "Renault-style components".
...
- `DESIGN.md` — full design system spec (Renault)
...
- Building production replica of Renault itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Renault style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Renault"
