...
description: "Capture a website and create a HyperFrames video from it. Triggers: 'use website-to-hyperframes', 'website to hyperframes', 'website-to-hyperframes task'."
...
- Task is unrelated to website to hyperframes — pick a domain-specific skill instead
...
| "Generic template is good enough" | Website To Hyperframes needs domain-specific judgment, not boilerplate |
...
Done when:
- Primary deliverable produced matches user's stated goal for website to hyperframes
...
- Input: standard user request involving website to hyperframes
