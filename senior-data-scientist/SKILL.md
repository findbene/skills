...
description: "World-class senior data scientist skill specialising in statistical modeling, experiment design, causal in. Triggers: 'use senior-data-scientist', 'senior data scientist', 'senior-data-scientist task."
...
- Task is unrelated to senior data scientist — pick a domain-specific skill instead
...
| "Generic template is good enough" | Senior Data Scientist needs domain-specific judgment, not boilerplate |
...
Done when:
- Primary deliverable produced matches user's stated goal for senior data scientist
...
- Input: standard user request involving senior data scientist
