---
name: start
description: Set up and initialize the video-transcriber project environment, check dependencies, and learn how to use all available commands. Use this skill whenever the user is opening the video-transcriber project for the first time, needs to install dependencies, is getting errors about missing packages or tools, or wants an overview of what the project can do. Apply whenever the user says "set up the project", "how do I start", "initialize the project", "check my environment", "install dependencies", "first time setup", "what commands are available", "how does this work", "project is not working", "venv not found", "ffmpeg missing", "how do I use this transcriber", or "run this first". Also trigger automatically if the user tries to run /bulk or /transcribe and the environment is not configured. Requires ~/video-transcriber/.
user_invocable: true
---
