...
description: "Cross-functional organizational health check combining signals from all C-suite roles. Triggers: 'use org-health-diagnostic', 'org health diagnostic', 'org-health-diagnostic task'."
...
- Task is unrelated to org health diagnostic — pick a domain-specific skill instead
...
| "Generic template is good enough" | Org Health Diagnostic needs domain-specific judgment, not boilerplate |
...
Done when:
- Primary deliverable produced matches user's stated goal for org health diagnostic
...
- Input: standard user request involving org health diagnostic
