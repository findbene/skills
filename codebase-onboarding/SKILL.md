...
description: "Analyze a codebase and generate structured onboarding documentation - architecture overview, key file inventory, local setup guide, and contribution checklist - tailored for new engineers, contractors, or tech leads. Use when onboarding new team members, creating handoff docs, or rebuilding stale project docs after large refactors. Trigger on: 'onboard me to', 'explain this codebase', 'new developer docs', 'project onboarding', 'codebase overview', 'handoff documentation', 'project orientation', 'understand this repo'."
