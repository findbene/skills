...
description: "Apply Linear.App design system aesthetic. Linear. Triggers: 'use design-linear.app', 'design linear.app', 'design-linear.app task'."
...
- Building production replica of Linear App itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Linear App style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Linear App"
