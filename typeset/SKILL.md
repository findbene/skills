---
name: typeset
description: "Improves typography by fixing font choices, hierarchy, sizing, weight, and readability so text feels intentional. Triggers: 'use typeset', 'typeset', 'typeset task'."
...
- Task is unrelated to typeset — pick a domain-specific skill instead
...
| "Generic template is good enough" | Typeset needs domain-specific judgment, not boilerplate |
...
Done when:
- Primary deliverable produced matches user's stated goal for typeset
...
- Input: standard user request involving typeset
