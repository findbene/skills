---
name: "design-cursor"
description: "Apply Cursor design system aesthetic. An AI-first code editor whose marketing site reads like a quietly-confident developer-tools. Triggers: 'use design-cursor', 'design cursor', 'design-cursor task'."
...
- Building production replica of Cursor itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Cursor style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Cursor"
