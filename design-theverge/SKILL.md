---
name: "design-theverge"
description: "Apply Theverge design system aesthetic. Theverge brand design system. Triggers: 'use design-theverge', 'design theverge', 'design-theverge task'."
allowed-tools: Glob, Grep, Read
---

# Theverge Design System

Reusable design system skill scaffolded from `DESIGN.md`. Source: VoltAgent/awesome-claude-design + getdesign.md.

## When to use

User asks to build, scaffold, or style UI matching Theverge's visual language. Also: "make it look like Theverge", "use Theverge aesthetic", "Theverge-style components".
...
- `DESIGN.md` — full design system spec (Theverge)
...
- Building production replica of Theverge itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Theverge style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Theverge"
