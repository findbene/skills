---
name: "design-tesla"
description: "Apply Tesla design system aesthetic. Tesla brand design system. Triggers: 'use design-tesla', 'design tesla', 'design-tesla task'."
...
- Building production replica of Tesla itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Tesla style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Tesla"
