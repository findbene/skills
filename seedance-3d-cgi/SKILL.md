...
- **Resolution & Frame Rate**: Up to 4K at 60fps or higher; supports cinematic 24fps and 30fps workflows
- **Animation & Motion**: Smooth procedural motion, physics simulation, creature rigging, character animation, particle systems, fluid dynamics
- **Lighting Precision**: HDRI illumination, physically accurate light simulation, global illumination (GI), caustics, volumetric lighting, subsurface scattering (SSS), caustic refraction
- **Material Complexity**: Procedural texturing, normal/displacement mapping, roughness/metallic workflows, anisotropic surfaces, fabric simulation, translucency, iridescence
- **Volumetrics & Particles**: Smoke, fire, fog, dust, rain, snow, magical effects, data visualization particles
...
- **Claymation/Plasticine**: Organic, handmade aesthetic; visible deformation and finger-marks; tactile surface quality; warm color palette. Used for: stop-motion inspired sequences, playful content. Prompt terms: "Claymation aesthetic," "plasticine texture," "stop-motion 3D," "handmade tactile quality."
...
- **Subsurface Scattering (SSS)**: Light penetrates translucent surfaces (skin, wax, marble, leaves). Prompt: "Fine facial SSS showing blood flow beneath skin," "marble with warm SSS in backlighting," "translucent jade with internal light diffusion."
...
- **Push/Dolly Zoom**: Forward motion while changing focal length. Prompt: "Dolly zoom creating dizzying perspective shift."
...
- **Lens Distortion**: Barrel/pincushion distortion. Prompt: "Subtle barrel distortion mimicking wide-angle lens."
...
1. **Polished Chrome/Mirror Steel**
...
11. **Crystal Clear Glass (High-Refraction)**
...
13. **Colored Glass (Emerald Green)**
...
18. **Marble (White with Gray Veins)**
...
#### 10. **Neon Practical Lights** (Cyberpunk, Color-Graded)
...
#### 5. **Ambiguous Particle Descriptions ("Many particles flowing")**
...
#### 12. **Over-Complicating Simple Prompts**
❌ **Mistake**: [30-line prompt for a simple 2-second product reveal]
✓ **Fix**: [Concise 8-line prompt hitting camera, lighting, material, motion, hook]
**Why**: Longer ≠ better. Clear, focused prompts yield better results than verbose, rambling ones.

---

## Platform Optimization

### Seedance 2.0 on Higgsfield Best Practices

#### Resolution & Performance
- **Target Resolution**: 1080p (delivery), 4K (reference). Seedance 2.0 on Higgsfield handles both optimally.
- **Frame Rate**: 24fps (cinematic standard), 30fps (smooth standard), 60fps (ultra-smooth). Specify in prompt.
...
- [ ] Render style chosen (Pixar, photorealistic, etc.)?
- [ ] Key light direction specified (degrees, Kelvin)?
- [ ] Fill light specified or described as absent?
- [ ] Rim/back light present?
- [ ] Material descriptions use technical language?
- [ ] Duration specified in seconds?
- [ ] Frame rate specified (24/30/60fps)?
- [ ] Particle effects (if any) quantified (density, color, speed)?
- [ ] No contradictions (e.g., "mirror-finish matte metal")?
- [ ] Color palette described (not just "cool colors" but specific colors)?
- [ ] Depth of field/focus strategy described?
- [ ] Composition mentioned (rule of thirds, symmetry, etc.)?
- [ ] Atmosphere/mood indicated?

### Material Property Checklist (If Using Complex Materials)

- [ ] Specularity level? (Zero/diffuse, soft/satin, sharp/mirror)
- [ ] Surface finish? (Smooth, textured, weathered, worn)
- [ ] Subsurface scattering needed? (For skin, wax, marble, fabric)
- [ ] Refraction/transparency? (Clear, frosted, colored)
- [ ] Metallic properties? (Polished, brushed, oxidized)
- [ ] Anisotropic effects? (Directional scratches, grain, weave)
- [ ] Color variation present? (Uniform or varied tone)
- [ ] Wear/damage/imperfection intentional? (Described explicitly)

### Lighting Checklist

- [ ] Key light source identified (natural/practical/artificial)?
- [ ] Key light direction specified (angle in degrees)?
- [ ] Key light color temperature specified (Kelvin)?
