---
name: "design-supabase"
description: "Apply Supabase design system aesthetic. Supabase brand design system. Triggers: 'use design-supabase', 'design supabase', 'design-supabase task'."
...
User asks to build, scaffold, or style UI matching Supabase's visual language. Also: "make it look like Supabase", "use Supabase aesthetic", "Supabase-style components".
...
- `DESIGN.md` — full design system spec (Supabase)
...
- Building production replica of Supabase itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Supabase style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Supabase"
