---
name: "design-resend"
description: "Apply Resend design system aesthetic. Resend brand design system. Triggers: 'use design-resend', 'design resend', 'design-resend task'."
...
User asks to build, scaffold, or style UI matching Resend's visual language. Also: "make it look like Resend", "use Resend aesthetic", "Resend-style components".
...
- `DESIGN.md` — full design system spec (Resend)
...
- Building production replica of Resend itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Resend style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Resend"
