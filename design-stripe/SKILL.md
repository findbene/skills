---
name: "design-stripe"
description: "Apply Stripe design system aesthetic. Stripe brand design system. Triggers: 'use design-stripe', 'design stripe', 'design-stripe task'."
...
User asks to build, scaffold, or style UI matching Stripe's visual language. Also: "make it look like Stripe", "use Stripe aesthetic", "Stripe-style components".
...
- `DESIGN.md` — full design system spec (Stripe)
...
- Building production replica of Stripe itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Stripe style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Stripe"
