...
description: "AI-powered customer support system implementation for RAG-based knowledge retrieval, ticket handling, and Supabase pgvector-backed support workflows. Use this skill any time customer support systems need to be built, support knowledge bases need to be connected, ticket handling needs to be automated, or customer query pipelines need to be implemented. Trigger immediately on: \"customer support\", \"support system\", \"knowledge base\", \"support ticket\", \"RAG support\", \"support agent\", \"ticket handling\", \"support workflow\", \"FAQ automation\", \"support bot\", \"customer queries\", \"pgvector support\", \"support pipeline\". If someone says \"build a customer support system\" this skill MUST trigger."
version: 1.0.0
triggers:
  - customer support
  - support ticket
