---
name: "design-superhuman"
description: "Apply Superhuman design system aesthetic. Superhuman brand design system. Triggers: 'use design-superhuman', 'design superhuman', 'design-superhuman task'."
...
User asks to build, scaffold, or style UI matching Superhuman's visual language. Also: "make it look like Superhuman", "use Superhuman aesthetic", "Superhuman-style components".
...
- `DESIGN.md` — full design system spec (Superhuman)
...
- Building production replica of Superhuman itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Superhuman style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Superhuman"
...
Superhuman brand design system.
