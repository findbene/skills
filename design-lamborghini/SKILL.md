---
name: "design-lamborghini"
description: "Apply Lamborghini design system aesthetic. Lamborghini brand design system. Triggers: 'use design-lamborghini', 'design lamborghini', 'design-lamborghini task'."
...
User asks to build, scaffold, or style UI matching Lamborghini's visual language. Also: "make it look like Lamborghini", "use Lamborghini aesthetic", "Lamborghini-style components".
...
- `DESIGN.md` — full design system spec (Lamborghini)
...
- Building production replica of Lamborghini itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Lamborghini style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Lamborghini"
...
Lamborghini brand design system.
