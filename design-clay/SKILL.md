---
name: "design-clay"
description: "Apply Clay design system aesthetic. A vibrant claymation-meets-data interface for Clay. Triggers: 'use design-clay', 'design clay', 'design-clay task'."
...
- Building production replica of Clay itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Clay style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Clay"
