---
name: "design-kraken"
description: "Apply Kraken design system aesthetic. Kraken brand design system. Triggers: 'use design-kraken', 'design kraken', 'design-kraken task'."
...
User asks to build, scaffold, or style UI matching Kraken's visual language. Also: "make it look like Kraken", "use Kraken aesthetic", "Kraken-style components".
...
- `DESIGN.md` — full design system spec (Kraken)
...
- Building production replica of Kraken itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Kraken style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Kraken"
