---
name: "design-pinterest"
description: "Apply Pinterest design system aesthetic. Pinterest brand design system. Triggers: 'use design-pinterest', 'design pinterest', 'design-pinterest task'."
...
User asks to build, scaffold, or style UI matching Pinterest's visual language. Also: "make it look like Pinterest", "use Pinterest aesthetic", "Pinterest-style components".
...
- `DESIGN.md` — full design system spec (Pinterest)
...
- Building production replica of Pinterest itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Pinterest style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Pinterest"
