...
1. **Problem identification** (0-2s): Open with a relatable pain point or attention-grabbing question → verify: file content matches expected shape
2. **Product reveal** (2-5s): Show the product/solution in context → verify: step output matches expected outcome
3. **CTA with urgency** (final 2s): Clear next step with time or quantity pressure → verify: step output matches expected outcome
