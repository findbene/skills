...
description: "Translate an existing Remotion (React-based) video composition into a HyperFrames HTML composition. Triggers: 'use remotion-to-hyperframes', 'remotion to hyperframes', 'remotion-to-hyperframes task'."
...
- Task is unrelated to remotion to hyperframes — pick a domain-specific skill instead
...
| "Generic template is good enough" | Remotion To Hyperframes needs domain-specific judgment, not boilerplate |
...
Done when:
- Primary deliverable produced matches user's stated goal for remotion to hyperframes
...
- Input: standard user request involving remotion to hyperframes
