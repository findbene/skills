---
name: "design-voltagent"
description: "Apply Voltagent design system aesthetic. Voltagent brand design system. Triggers: 'use design-voltagent', 'design voltagent', 'design-voltagent task'."
...
User asks to build, scaffold, or style UI matching Voltagent's visual language. Also: "make it look like Voltagent", "use Voltagent aesthetic", "Voltagent-style components".
...
- `DESIGN.md` — full design system spec (Voltagent)
...
- Building production replica of Voltagent itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Voltagent style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Voltagent"
