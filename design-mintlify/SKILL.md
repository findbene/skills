...
description: "Apply Mintlify design system aesthetic. Mintlify brand design system. Triggers: 'use design-mintlify', 'design mintlify', 'design-mintlify task'."
...
- Building production replica of Mintlify itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Mintlify style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Mintlify"
