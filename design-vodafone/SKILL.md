---
name: "design-vodafone"
description: "Apply Vodafone design system aesthetic. Vodafone brand design system. Triggers: 'use design-vodafone', 'design vodafone', 'design-vodafone task'."
...
User asks to build, scaffold, or style UI matching Vodafone's visual language. Also: "make it look like Vodafone", "use Vodafone aesthetic", "Vodafone-style components".
...
- `DESIGN.md` — full design system spec (Vodafone)
...
- Building production replica of Vodafone itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Vodafone style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Vodafone"
