---
name: "design-intercom"
description: "Apply Intercom design system aesthetic. Intercom brand design system. Triggers: 'use design-intercom', 'design intercom', 'design-intercom task'."
...
User asks to build, scaffold, or style UI matching Intercom's visual language. Also: "make it look like Intercom", "use Intercom aesthetic", "Intercom-style components".
...
- `DESIGN.md` — full design system spec (Intercom)
...
- Building production replica of Intercom itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Intercom style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Intercom"
