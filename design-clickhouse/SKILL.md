...
description: "Apply ClickHouse design system aesthetic. A high-performance database interface anchored on near-pure black canvas wit. Triggers: 'use design-clickhouse', 'design clickhouse', 'design-clickhouse task."
...
- Building production replica of Clickhouse itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Clickhouse style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Clickhouse"
