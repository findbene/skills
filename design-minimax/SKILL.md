---
name: "design-minimax"
description: "Apply Minimax design system aesthetic. Minimax brand design system. Triggers: 'use design-minimax', 'design minimax', 'design-minimax task'."
...
User asks to build, scaffold, or style UI matching Minimax's visual language. Also: "make it look like Minimax", "use Minimax aesthetic", "Minimax-style components".
...
- `DESIGN.md` — full design system spec (Minimax)
...
- Building production replica of Minimax itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Minimax style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Minimax"
