# Council Session Process

A council session is a 6-step pipeline. Always run all steps. Always spawn advisors in parallel.
...
1. Their advisor identity and thinking style (from `references/advisors.md`)
...
Your thinking style: [advisor description from references/advisors.md]
