...
description: Identifies high-quality leads for your product or service by analyzing your business, searching for target companies, and providing actionable contact strategies. Use this skill whenever the user wants to find potential customers, build a sales prospect list, research companies that match an ideal customer profile, prepare for business development outreach, or identify partnership targets. Apply whenever the user says "find leads for my product", "who should I reach out to", "build me a prospect list", or "identify companies that need X" — use this structured approach rather than a simple web search.
---
