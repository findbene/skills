---
name: "design-cohere"
description: "Apply Cohere design system aesthetic. Cohere's 2026 web system is a controlled enterprise AI interface built from stark white edit. Triggers: 'use design-cohere', 'design cohere', 'design-cohere task."
...
- Building production replica of Cohere itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Cohere style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Cohere"
