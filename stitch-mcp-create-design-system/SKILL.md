...
description: "Creates a reusable Stitch Design System from theme tokens — colors, fonts, r. Triggers: 'use stitch-mcp-create-design-system', 'stitch mcp create design system', 'stitch-mcp-create-design-system task."
allowed-tools:
  - "stitch*:*"
---
...
- Task is unrelated to stitch mcp create design system — pick a domain-specific skill instead
...
| "Generic template is good enough" | Stitch Mcp Create Design System needs domain-specific judgment, not boilerplate |
...
Done when:
- Primary deliverable produced matches user's stated goal for stitch mcp create design system
...
- Input: standard user request involving stitch mcp create design system
