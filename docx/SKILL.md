---
name: docx
description: Create, read, edit, and format Word documents (.docx) using python-docx (Python) or the docx npm package (Node.js). Trigger immediately any time a user mentions ".docx", "Word document", "Word file", "DOCX", "create a Word doc", "edit Word document", "generate a report in Word", "Word template", "document formatting", "Word report", "Microsoft Word", "Word export", or shares a .docx file. Also trigger when the user asks to produce a report, contract, letter, resume, or any structured document that should be delivered as a .docx file. Do not wait for the user to name the library — if the output is a Word document, this skill applies.
---
