---
name: pptx
description: Create, read, edit, and design PowerPoint presentations (.pptx) programmatically using pptxgenjs (Node.js) or python-pptx (Python). Trigger immediately any time a user mentions ".pptx", "PowerPoint", "slide deck", "presentation", "create slides", "PPTX", "pitch deck", "slide show", "add slide", "presentation file", "business presentation", "slide design", "deck", or shares a .pptx file. Also trigger when the user asks to build a report, pitch, walkthrough, or any structured visual output that would naturally live in slides. Do not wait for the user to name the library — if the output is a presentation, this skill applies.
---
