...
description: "Design multi-agent orchestration workflows - DAG-based pipelines, agent handoff patterns, state management, error recovery, and coordination strategies for AI agent systems. Use when architecting multi-agent systems, designing agent pipelines, or planning how agents collaborate on a shared task. Trigger on: 'agent workflow', 'multi-agent', 'agent orchestration', 'agent pipeline', 'agent handoff', 'AI agents', 'agent coordination', 'agent DAG', 'orchestrate agents', 'agent system design'."
