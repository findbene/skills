...
description: >
  Generate and optimize SEO competitor comparison and alternatives pages that convert.
  Covers four page types: "X vs Y" head-to-head comparisons, "Alternatives to X"
  roundups, "Best [Category] Tools" listicles, and feature comparison matrices.
  Includes structured data (Product, ItemList schema), conversion optimization,
  FAQ sections, and data accuracy requirements. Targets high-commercial-intent
  keywords like "[tool] vs [competitor]", "[tool] alternatives", "best [category]
  software". Make sure to use this skill whenever the user mentions: "comparison
  page", "vs page", "X vs Y", "alternatives page", "best tools for", "competitor
  comparison", "feature comparison", "comparison table", "software comparison",
  "compare tools", "[product] vs [competitor]", "alternatives to [product]",
  "switching from [tool]", or any request to build pages targeting competitive
  search intent — even if they describe it as "landing page for competitor terms".
user-invokable: true
...
- Compare two products/services head-to-head, feature by feature
- Present a balanced analysis with a clear verdict and justification
- Target keyword: `[Product A] vs [Product B]`

### 2. "Alternatives to X" Pages
- List alternatives to a specific product/service
- Cover each alternative with a brief summary, pros/cons, and best-for use case
- Target keyword: `[Product] alternatives`, `best alternatives to [Product]`

### 3. "Best [Category] Tools" Roundup Pages
- Curate the top tools/services in a category
- State ranking criteria clearly upfront
- Target keyword: `best [category] tools [year]`, `top [category] software`

### 4. Comparison Table Pages
- Build a feature matrix with multiple products in columns
- Make it sortable/filterable when interactive
...
- `COMPARISON-PAGE.md`: Ready-to-implement page structure with all sections filled
- Include a feature matrix table
- Include a content outline with word count targets (minimum 1,500 words)
...
- Identify related long-tail opportunities
- Flag content gaps vs existing competitor pages

### Recommendations
- Propose content improvements for existing comparison pages
- Identify new comparison page opportunities
- Recommend schema markup additions
- Suggest conversion optimization improvements
