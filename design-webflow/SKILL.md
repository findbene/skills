---
name: "design-webflow"
description: "Apply Webflow design system aesthetic. Webflow brand design system. Triggers: 'use design-webflow', 'design webflow', 'design-webflow task'."
...
User asks to build, scaffold, or style UI matching Webflow's visual language. Also: "make it look like Webflow", "use Webflow aesthetic", "Webflow-style components".
...
- `DESIGN.md` — full design system spec (Webflow)
...
- Building production replica of Webflow itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Webflow style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Webflow"
