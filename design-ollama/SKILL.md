---
name: "design-ollama"
description: "Apply Ollama design system aesthetic. Ollama brand design system. Triggers: 'use design-ollama', 'design ollama', 'design-ollama task'."
...
User asks to build, scaffold, or style UI matching Ollama's visual language. Also: "make it look like Ollama", "use Ollama aesthetic", "Ollama-style components".
...
- `DESIGN.md` — full design system spec (Ollama)
...
- Building production replica of Ollama itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Ollama style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Ollama"
