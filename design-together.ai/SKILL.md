...
description: "Apply Together.Ai design system aesthetic. Together. Triggers: 'use design-together.ai', 'design together.ai', 'design-together.ai task'."
...
- Building production replica of Together Ai itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Together Ai style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Together Ai"
