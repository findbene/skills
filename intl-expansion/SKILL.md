---
name: "intl-expansion"
description: "International market expansion strategy. Market selection, entry modes, localization, regulatory compliance, and go-to-market b. Triggers: 'use intl-expansion', 'intl expansion', 'intl-expansion task."
...
- Task is unrelated to intl expansion — pick a domain-specific skill instead
...
| "Generic template is good enough" | Intl Expansion needs domain-specific judgment, not boilerplate |
...
Done when:
- Primary deliverable produced matches user's stated goal for intl expansion
...
- Input: standard user request involving intl expansion
