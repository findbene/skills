...
description: "Apply Coinbase design system aesthetic. An institutional-grade crypto exchange whose marketing surfaces read like a quietly-confident financial-services brand. Use when scaffolding UI components, generating styled pages, or matching Coinbase's visual language (colors, typography, spacing, components). Loads bundled DESIGN.md with full token spec, type scale, component patterns, and brand rationale."
---
