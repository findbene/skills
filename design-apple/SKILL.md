---
name: "design-apple"
description: "Apply Apple design system aesthetic. A photography-first interface that turns marketing into a museum gallery. Use when scaffolding UI components, generating styled pages, or matching Apple's visual language (colors, typography, spacing, components). Loads bundled DESIGN.md with full token spec, type scale, component patterns, and brand rationale."
---
