---
name: "design-playstation"
description: "Apply Playstation design system aesthetic. Playstation brand design system. Triggers: 'use design-playstation', 'design playstation', 'design-playstation task'."
...
User asks to build, scaffold, or style UI matching Playstation's visual language. Also: "make it look like Playstation", "use Playstation aesthetic", "Playstation-style components".
...
- `DESIGN.md` — full design system spec (Playstation)
...
- Building production replica of Playstation itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Playstation style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Playstation"
...
Playstation brand design system.
