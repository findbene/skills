---
name: "design-bugatti"
description: "Apply Bugatti design system aesthetic. An austere luxury-automotive interface that uses near-pure black canvas, white uppercase. Triggers: 'use design-bugatti', 'design bugatti', 'design-bugatti task."
...
- Building production replica of Bugatti itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Bugatti style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Bugatti"
