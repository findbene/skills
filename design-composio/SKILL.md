...
description: "Apply Composio design system aesthetic. A developer-tools brand for AI-agent tool integration whose marketing surfaces lean. Triggers: 'use design-composio', 'design composio', 'design-composio task'."
...
- Building production replica of Composio itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Composio style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Composio"
