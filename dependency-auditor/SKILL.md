...
description: "Comprehensive dependency vulnerability scanning and license compliance auditing across npm, pip, cargo, go.mod, maven, and composer. Detects CVEs, outdated packages, supply-chain risks, and license violations. Use whenever dependencies need auditing, a security scan is required, or package upgrades need safe planning. Trigger on: 'audit dependencies', 'dependency vulnerabilities', 'CVE scan', 'npm audit', 'outdated packages', 'license compliance', 'dependency security', 'check my packages', 'supply chain risk'."
