---
name: "design-vercel"
description: "Apply Vercel design system aesthetic. Vercel brand design system. Triggers: 'use design-vercel', 'design vercel', 'design-vercel task'."
...
User asks to build, scaffold, or style UI matching Vercel's visual language. Also: "make it look like Vercel", "use Vercel aesthetic", "Vercel-style components".
...
- `DESIGN.md` — full design system spec (Vercel)
...
- Building production replica of Vercel itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Vercel style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Vercel"
