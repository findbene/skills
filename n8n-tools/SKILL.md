---
name: n8n-tools
description: "n8n workflow automation toolkit with 1236 nodes for building, validating, managing, and deploying workflows via MCP. Use this skill any time n8n workflows need to be created or managed, workflow JSON needs to be validated, n8n instances need to be managed, or workflow templates need to be found. Trigger immediately on: \"n8n\", \"n8n workflow\", \"n8n node\", \"workflow automation\", \"automate with n8n\", \"n8n tools\", \"n8n MCP\", \"n8n instance\", \"workflow template\", \"n8n API\", \"workflow JSON\", \"n8n credential\", \"n8n trigger\", \"connect via n8n\". If someone says \"I want to automate X using n8n\" this skill MUST trigger."
---
