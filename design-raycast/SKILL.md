---
name: "design-raycast"
description: "Apply Raycast design system aesthetic. Raycast brand design system. Triggers: 'use design-raycast', 'design raycast', 'design-raycast task'."
...
User asks to build, scaffold, or style UI matching Raycast's visual language. Also: "make it look like Raycast", "use Raycast aesthetic", "Raycast-style components".
...
- `DESIGN.md` — full design system spec (Raycast)
...
- Building production replica of Raycast itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Raycast style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Raycast"
