...
name: seo-image-gen
description: >
  AI image generation for SEO assets using Gemini via nanobanana-mcp. Generates
  production-ready OG/social preview images (1200x630), blog hero images, product
  photography (clean white background), infographics, schema-compliant images, and
  batch variations. Maps SEO use cases to optimized domain modes and aspect ratios.
  Requires banana extension installed (nanobanana-mcp via mcp-proxy). Make sure to
  use this skill whenever the user wants to generate or create any image for SEO
  purposes and mentions: "generate image", "OG image", "social preview image", "Open
  Graph image", "hero image", "blog image", "product photo", "infographic", "SEO
  image", "create visual", "banner", "thumbnail", "featured image", "schema image",
  "Pinterest pin", "Twitter card image", or asks for any visual asset to accompany
  web content. Also invoke when the user says "image-gen" or asks to make their
  content more visual for sharing.
user-invokable: true
