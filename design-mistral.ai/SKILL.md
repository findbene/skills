...
description: "Apply Mistral.Ai design system aesthetic. Mistral. Triggers: 'use design-mistral.ai', 'design mistral.ai', 'design-mistral.ai task'."
...
- Building production replica of Mistral Ai itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Mistral Ai style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Mistral Ai"
