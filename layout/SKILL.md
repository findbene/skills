---
name: layout
description: "Improve layout, spacing, and visual rhythm. Fixes monotonous grids, inconsistent spacing, and weak visual hierarchy. Triggers: 'use layout', 'layout', 'layout task'."
...
layout feeling off, spacing issues, visual hierarchy, crowded UI, alignment problems, or wanting better composition

## When NOT to use

- Task is unrelated to layout — pick a domain-specific skill instead
...
| "Generic template is good enough" | Layout needs domain-specific judgment, not boilerplate |
...
Done when:
- Primary deliverable produced matches user's stated goal for layout
...
- Input: standard user request involving layout
