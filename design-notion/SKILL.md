---
name: "design-notion"
description: "Apply Notion design system aesthetic. Notion brand design system. Triggers: 'use design-notion', 'design notion', 'design-notion task'."
...
User asks to build, scaffold, or style UI matching Notion's visual language. Also: "make it look like Notion", "use Notion aesthetic", "Notion-style components".
...
- `DESIGN.md` — full design system spec (Notion)
...
- Building production replica of Notion itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Notion style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Notion"
