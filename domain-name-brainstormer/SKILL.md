...
description: Generates creative domain name ideas for your project and checks availability across multiple TLDs (.com, .io, .dev, .ai, etc.). Use this skill whenever the user wants to name a project, find a domain for a new startup or product, check domain availability, register a brand name, or brainstorm alternatives when their first choice is taken. Apply whenever the user says "suggest domain names", "what should I call my project", "find an available domain", or "help me pick a name" — do not just list ideas, use this structured approach to check real availability.
---
