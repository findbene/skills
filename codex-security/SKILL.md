---
name: codex-security
description: "Runs Codex CLI in security-specialist mode. Focuses exclusively on vulnerabilities, secrets exposure, auth bypass, injection vectors, and tenant isolation gaps."
---

# /codex:security — Deep Security Audit
