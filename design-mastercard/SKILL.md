---
name: "design-mastercard"
description: "Apply Mastercard design system aesthetic. Mastercard brand design system. Triggers: 'use design-mastercard', 'design mastercard', 'design-mastercard task'."
...
User asks to build, scaffold, or style UI matching Mastercard's visual language. Also: "make it look like Mastercard", "use Mastercard aesthetic", "Mastercard-style components".
...
- `DESIGN.md` — full design system spec (Mastercard)
...
- Building production replica of Mastercard itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Mastercard style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Mastercard"
...
Mastercard brand design system.
