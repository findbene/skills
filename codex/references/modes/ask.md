# Mode: ask — Free-Form Codebase Question

Read-only question interface to Codex. Use for second opinions, decision exploration, or specific codebase investigations.
...
Present Codex's response directly. Add commentary only if Codex missed something or the answer needs clarification.
