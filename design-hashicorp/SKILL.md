---
name: "design-hashicorp"
description: "Apply Hashicorp design system aesthetic. Hashicorp brand design system. Triggers: 'use design-hashicorp', 'design hashicorp', 'design-hashicorp task'."
...
User asks to build, scaffold, or style UI matching Hashicorp's visual language. Also: "make it look like Hashicorp", "use Hashicorp aesthetic", "Hashicorp-style components".
...
- `DESIGN.md` — full design system spec (Hashicorp)
...
- Building production replica of Hashicorp itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Hashicorp style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Hashicorp"
