---
name: "design-zapier"
description: "Apply Zapier design system aesthetic. Zapier brand design system. Triggers: 'use design-zapier', 'design zapier', 'design-zapier task'."
...
User asks to build, scaffold, or style UI matching Zapier's visual language. Also: "make it look like Zapier", "use Zapier aesthetic", "Zapier-style components".
...
- `DESIGN.md` — full design system spec (Zapier)
...
- Building production replica of Zapier itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Zapier style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Zapier"
