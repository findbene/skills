...
description: "Generate operational runbooks for services - start/stop/health/rollback workflows, escalation paths, and incident handling procedures. Use whenever a service lacks a runbook, runbooks are inconsistent across teams, or on-call onboarding needs standardized ops docs. Trigger on: 'generate runbook', 'create runbook', 'operational runbook', 'runbook for', 'service runbook', 'on-call docs', 'incident runbook', 'deployment runbook', 'SOP for service'."
