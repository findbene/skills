---
name: "code-reviewer"
description: "Code review automation for TypeScript, JavaScript, Python, Go, Swift, Kotlin. Triggers: 'use code-reviewer', 'code reviewer', 'code-reviewer task'."
...
- Task is unrelated to code reviewer — pick a domain-specific skill instead
...
| "Generic template is good enough" | Code Reviewer needs domain-specific judgment, not boilerplate |
...
Done when:
- Primary deliverable produced matches user's stated goal for code reviewer
...
- Input: standard user request involving code reviewer
