...
description: "Apply Opencode.Ai design system aesthetic. Opencode. Triggers: 'use design-opencode.ai', 'design opencode.ai', 'design-opencode.ai task'."
...
- Building production replica of Opencode Ai itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Opencode Ai style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Opencode Ai"
