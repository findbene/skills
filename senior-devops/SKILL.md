---
name: "senior-devops"
description: "Comprehensive DevOps skill for CI/CD, infrastructure automation, containerization, and cloud platforms (AWS, GCP, Azure). Triggers: 'use senior-devops', 'senior devops', 'senior-devops task'."
...
- Task is unrelated to senior devops — pick a domain-specific skill instead
...
| "Generic template is good enough" | Senior Devops needs domain-specific judgment, not boilerplate |
...
Done when:
- Primary deliverable produced matches user's stated goal for senior devops
...
- Input: standard user request involving senior devops
