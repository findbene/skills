---
name: "design-lovable"
description: "Apply Lovable design system aesthetic. Lovable brand design system. Triggers: 'use design-lovable', 'design lovable', 'design-lovable task'."
...
User asks to build, scaffold, or style UI matching Lovable's visual language. Also: "make it look like Lovable", "use Lovable aesthetic", "Lovable-style components".
...
- `DESIGN.md` — full design system spec (Lovable)
...
- Building production replica of Lovable itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Lovable style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Lovable"
