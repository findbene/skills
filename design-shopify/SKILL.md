---
name: "design-shopify"
description: "Apply Shopify design system aesthetic. Shopify brand design system. Triggers: 'use design-shopify', 'design shopify', 'design-shopify task'."
...
User asks to build, scaffold, or style UI matching Shopify's visual language. Also: "make it look like Shopify", "use Shopify aesthetic", "Shopify-style components".
...
- `DESIGN.md` — full design system spec (Shopify)
...
- Building production replica of Shopify itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Shopify style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Shopify"
