...
description: "Apply Airtable design system aesthetic. A sober, editorial workflow-software interface anchored on white canvas and dark-ink. Triggers: 'use design-airtable', 'design airtable', 'design-airtable task."
...
- Building production replica of Airtable itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Airtable style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Airtable"
