...
Charm pricing, anchoring, Rule of 100, good-better-best tiers, and mental accounting framing — all the models for how people perceive prices.

See [references/pricing-psychology.md](references/pricing-psychology.md) for the full reference.
...
Feedback loops, compounding, network effects, flywheel, switching costs, exploration vs. exploitation, critical mass, survivorship bias.

See [references/growth-models.md](references/growth-models.md) for the full reference.

## Quick Reference

Challenge-to-model lookup table (low conversions, price objections, trust, urgency, retention, growth, onboarding).

See [references/quick-reference.md](references/quick-reference.md).
