---
name: "design-revolut"
description: "Apply Revolut design system aesthetic. Revolut brand design system. Triggers: 'use design-revolut', 'design revolut', 'design-revolut task'."
...
User asks to build, scaffold, or style UI matching Revolut's visual language. Also: "make it look like Revolut", "use Revolut aesthetic", "Revolut-style components".
...
- `DESIGN.md` — full design system spec (Revolut)
...
- Building production replica of Revolut itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Revolut style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Revolut"
