---
name: "design-nvidia"
description: "Apply Nvidia design system aesthetic. Nvidia brand design system. Triggers: 'use design-nvidia', 'design nvidia', 'design-nvidia task'."
...
User asks to build, scaffold, or style UI matching Nvidia's visual language. Also: "make it look like Nvidia", "use Nvidia aesthetic", "Nvidia-style components".
...
- `DESIGN.md` — full design system spec (Nvidia)
...
- Building production replica of Nvidia itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Nvidia style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Nvidia"
