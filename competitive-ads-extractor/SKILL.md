...
description: Extracts and analyzes competitors' ads from ad libraries (Facebook, LinkedIn, etc.) to understand what messaging, problems, and creative approaches are working. Use this skill whenever the user wants to research competitor ads, scrape an ad library, analyze what messaging is working for a competitor, plan an ad campaign, find inspiration for ad creative, or understand market positioning through ads. Apply whenever the user mentions "competitor ads", "ad library", "what ads is [Company] running", or "analyze their advertising".
---
