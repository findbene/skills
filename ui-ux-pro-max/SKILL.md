...
> **Full annotated rules for all 10 categories:** `references/ux-rules.md`
> Load that file when you need the complete bullet-level rule set for any category.

| Priority | Category | Impact | Key Rules (Top 3) |
|----------|----------|--------|--------------------|
| 1 | **Accessibility** | CRITICAL | 4.5:1 contrast · visible focus rings · alt text + aria-labels |
| 2 | **Touch & Interaction** | CRITICAL | 44×44pt targets · 8px spacing · no hover-only interactions |
| 3 | **Performance** | HIGH | WebP/AVIF · lazy load · skeleton screens for >300ms waits |
| 4 | **Style Selection** | HIGH | Match style to product · no emoji icons · one icon set |
| 5 | **Layout & Responsive** | HIGH | Mobile-first · systematic breakpoints · no horizontal scroll |
| 6 | **Typography & Color** | MEDIUM | 1.5× line-height · semantic color tokens · 16px min body |
| 7 | **Animation** | MEDIUM | 150–300ms · transform/opacity only · respect reduced-motion |
| 8 | **Forms & Feedback** | MEDIUM | Visible labels · error below field · inline validation on blur |
| 9 | **Navigation Patterns** | HIGH | ≤5 bottom nav items · predictable back · state preservation |
| 10 | **Charts & Data** | LOW | Match chart to data type · accessible color pairs · tooltips |
