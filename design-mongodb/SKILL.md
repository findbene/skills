---
name: "design-mongodb"
description: "Apply Mongodb design system aesthetic. Mongodb brand design system. Triggers: 'use design-mongodb', 'design mongodb', 'design-mongodb task'."
...
User asks to build, scaffold, or style UI matching Mongodb's visual language. Also: "make it look like Mongodb", "use Mongodb aesthetic", "Mongodb-style components".
...
- `DESIGN.md` — full design system spec (Mongodb)
...
- Building production replica of Mongodb itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Mongodb style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Mongodb"
