---
name: "design-runwayml"
description: "Apply Runwayml design system aesthetic. Runwayml brand design system. Triggers: 'use design-runwayml', 'design runwayml', 'design-runwayml task'."
...
User asks to build, scaffold, or style UI matching Runwayml's visual language. Also: "make it look like Runwayml", "use Runwayml aesthetic", "Runwayml-style components".
...
- `DESIGN.md` — full design system spec (Runwayml)
...
- Building production replica of Runwayml itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Runwayml style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Runwayml"
