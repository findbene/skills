---
name: "design-spacex"
description: "Apply Spacex design system aesthetic. Spacex brand design system. Triggers: 'use design-spacex', 'design spacex', 'design-spacex task'."
...
User asks to build, scaffold, or style UI matching Spacex's visual language. Also: "make it look like Spacex", "use Spacex aesthetic", "Spacex-style components".
...
- `DESIGN.md` — full design system spec (Spacex)
...
- Building production replica of Spacex itself (trademark / IP risk)
...
- Input: "Build a marketing hero in Spacex style"
...
### Example 2 — Card grid
- Input: "Card grid that looks like Spacex"
